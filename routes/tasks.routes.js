...
tasksRoutes.post("/api/tasks/submit/:taskId",authMiddleware,managerController.submitTask)
tasksRoutes.get("/api/tests",authMiddleware, managerController.getTestOption)
